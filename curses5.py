...
def perdu(win, snake):
	...
	if snake[0] in snake[1:] :
		...
		texte ="GAME OVER YEEEAAAAAAAAAAAH"
		longueur_texte = len(texte)
		ligne = win.getmaxyx()[0]//2
		colonne = win.getmaxyx()[1]//2 - longueur_texte//2
		win.addstr(ligne, colonne, texte, curses.color_pair(4))
		win.refresh()
